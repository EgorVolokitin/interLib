...
namespace Academy.HoloToolkit.Unity
{
    ...
    public class BasicCursor : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            {
                Debug.print("Must have a GazeManager somewhere in the scene.");
                return;
            }

            if ((GazeManager.Instance.RaycastLayerMask & this.gameObject.layer) == 0)
            {
                Debug.print("The cursor has a layer that is checked in the GazeManager's Raycast Layer Mask.  Change the cursor layer (e.g.: to Ignore Raycast) or uncheck the layer in GazeManager: " +
            ...
            {
                Debug.print("This script requires that your cursor asset has a MeshRenderer component on it.");
                return;
            }
